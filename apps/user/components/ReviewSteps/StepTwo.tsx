  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-6 mb-8">
        <div className="relative flex-shrink-0">
          {data.profileImage
            ...
            : (
              <div className="w-20 h-20 rounded-full bg-black/30 border-2 border-dashed border-amber-400/30 flex items-center justify-center">
                <input
                  type="file"
                  accept="image/*"
        ...
        <div className="flex-grow">
          <p className="text-amber-200 text-sm mb-1">Profile Picture</p>
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-amber-200 mb-2">Name</label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-black/30 border border-amber-400/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-400/50 text-gray-100 placeholder-gray-400"
