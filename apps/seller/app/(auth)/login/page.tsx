      ...
      <Card className="w-full max-w-md bg-white/10 backdrop-blur-sm border-gray-700 shadow-xl">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-3xl font-bold text-white">
            Welcome to Review-snap
          </CardTitle>
          <CardDescription className="text-gray-300">
            Sign in to your account to manage your testimonials
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Button
            ...
            disabled={isLoading}
            className="w-full py-6 bg-white text-black hover:bg-gray-100 flex items-center justify-center gap-2 text-lg"
          >
            {isLoading
              ? (
